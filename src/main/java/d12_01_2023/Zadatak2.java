...
//Transakcija se vrsi tako sto sa jednog racuna skida (trazena suma) + (provizija), a na drugi racun
//dodaje samo (trazena suma).
...
public class Zadatak2 {
    public static void main(String[] args) {
        Racun r1 = new Racun("155-234566-45", "Marija Tomic", 25000);
        Racun r2 = new Racun("150-546378-72", "Danica Tomic", 115000);

        Transakcija t1 = new Transakcija(56, r2, r1);
        t1.izvrsiTransakciju(2500.00);
